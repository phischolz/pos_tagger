 ...
 * RapidMiner GmbH
 * 
 * Copyright (C) 2018-2018 by RapidMiner GmbH and the contributors
 * 
 ...
 */
package com.rapidminer.pos_tagger;
 ...
 * @author REPLACEME
 */
public final class PluginInitposTagger {

		private PluginInitposTagger() {
